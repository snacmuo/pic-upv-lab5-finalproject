...
from upvfab.sin300.cband.tech import LAYER

##############################
# grating couplers Rectangular
##############################

# TBD: Update with UPVfab Daniel's GC designs
@gf.cell
def grating_coupler_rectangular(
    period=1.977,
    n_periods: int = 12,
    length_taper: float = 120.0,
...
# TBD: Repeat Lumerical example for our designs
# @gf.cell
